...
The 'dbt_project' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `dbt_project` directory. We recommend making
...
`[dev yourname] dbt_project_job` to your workspace.
...
When deploying to this target, note that the default job at resources/dbt_project_job.yml
